...
const AbandonRegister = () => {
    ...
    const [register, _student, legalGuardians, carnet, revitionState] = FormatRegister({ action, student, schoolTag: false });
    return (
        <>
...
export default AbandonRegister;